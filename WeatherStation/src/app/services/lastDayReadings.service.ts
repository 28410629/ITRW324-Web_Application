...
@Injectable()
export class LastDayReadingsService {
  constructor(private http: HttpClient, private common: FetchJsonUtilities) {}

  public FetchTodayReadings() {
    return this.common.fetchJSON('https://weatherstationapi.ddns.net:5001/api/get/lastdayreadings')
